...
BEGIN
    ...
    INSERT INTO edges (from_stop_id, to_stop_id, distance, start_time, edge_type)
    SELECT from_stop_id, to_stop_id, min_transfer_time, '', 0 FROM transfers;
    
    -- 2. Add the edges between stops in the same trip
    INSERT INTO edges (from_stop_id, to_stop_id, distance, start_time, edge_type)
    SELECT s1.stop_id, s2.stop_id, 0, s1.departure_time, 1
